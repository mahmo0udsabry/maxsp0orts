...
<body>
    ...
    <iframe id="playerFrame" src="https://live35.yalla-shoot-tv.biz/chtv/ch1.php" allow="autoplay" sandbox="allow-same-origin allow-scripts"  allowfullscreen="" scrolling="no" onload="removeAdsAndUnmute()"></iframe>
